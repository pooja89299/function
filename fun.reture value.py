...
#Kuch functions jo humne use kare hain, vapas kuch value dete hain. 
# Matlab kuch data vapas dete hain. Abhi tak humne aise functions likhe
#  hain jo kuch bhi vapas nahi dete. 
